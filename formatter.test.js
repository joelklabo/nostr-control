...
describe('Formatter', () => {
	...
	test('forward_event', () => {
		...
		expect(formatted).toBe('Forwarded 100000 sat to 103x1x1 from 103x2x1 for a fee of 1 sat')
	})
	...
	test('coin_movement', () => {
		...
		expect(formatted).toBe('Coin movement chain_mvt credit: 2000000 sat, debit: 0 sat')
	})
	...
	test('openchannel_peer_sigs', () => {
		...
		expect(formatted).toBe('Open channel peer sigs a2d0851832f0e30a0cf778a826d72f077ca86b69f72677e0267f23f63a0599b4')
	})
